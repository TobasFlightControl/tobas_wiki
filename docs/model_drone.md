...
このチュートリアルでは Autodesk の Fusion360 を使用します．
...
Gazebo (物理シミュレータ) と同じく，ENU 座標系 (X 軸を前，Y 軸を左，Z 軸を上) に一致させることをおすすめします．
...
注意点 2 にあるように， ENU 座標系に一致するように配置します．
...
注意点 2 にあるように，機体座標系を ENU 座標系に一致するように配置します．
